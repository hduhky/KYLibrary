...
- (void)setup {
    ...
    [cancel setBackgroundImage:[KYUtils imageWithColor:[[UIColor whiteColor] colorWithAlphaComponent:0.3]] forState:UIControlStateNormal];
    [cancel setBackgroundImage:[KYUtils imageWithColor:[[UIColor lightTextColor] colorWithAlphaComponent:0.3]] forState:UIControlStateHighlighted];
    ...
    [sure setBackgroundImage:[KYUtils imageWithColor:[[UIColor whiteColor] colorWithAlphaComponent:0.3]] forState:UIControlStateNormal];
    [sure setBackgroundImage:[KYUtils imageWithColor:[[UIColor lightTextColor] colorWithAlphaComponent:0.3]] forState:UIControlStateHighlighted];
